...
public class Translation {
	...
	public String parser(String startLang, String endLang, String text) throws Exception {
		...
		// and encodes desired text to UTF-8 for conversion to endLang through Google
		// Translate API
		String url = "https://translate.googleapis.com/translate_a/single?" + "client=gtx&" + "sl=" + startLang + "&tl="
				+ endLang + "&dt=t&q=" + URLEncoder.encode(text, "UTF-8");
	...
	public String parseOutput(String text) throws Exception {
		...
		// Must use javascript object notation arrays to transmit data between the
