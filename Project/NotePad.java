...
public class NotePad extends JFrame implements ActionListener {
    ...
    private Menu spellCheck = new Menu();
    private Menu translate = new Menu();
    private Menu invert=new Menu();
    private MenuItem normal = new MenuItem();
    private MenuItem inverted = new MenuItem();
    public NotePad() {
        this.setSize(1000, 1000); // set the initial size of the window
        this.setTitle("CAZA NotePad Pro"); // set the title of the window
        setDefaultCloseOperation(EXIT_ON_CLOSE);


        this.textArea.setFont(new Font("Times New Roman", Font.PLAIN, 12)); // set a default font for the TextArea
        ...
        this.menuBar.add(this.spellCheck);
        this.menuBar.add(this.translate);
        ...
        this.spellCheck.setLabel("Spell Check");
        this.translate.setLabel("Translate");
